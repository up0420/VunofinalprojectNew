...
# cardiomegaly & pneumothorax 모델 설정
# def cardioPneumo(request):
...
# cardio, pneumo, effusion, atelec 병합
def chestMateRunner(request):
    Model = ChestMateRunner(path_weight_cmptx='C:\\VunofinalprojectNew\\locallibrary\\catalog\\model_cmptx.pth', 
                            path_weight_eff_atel='C:\\VunofinalprojectNew\\locallibrary\\catalog\\model_eff_atel.pth')
